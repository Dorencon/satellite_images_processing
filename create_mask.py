...
def create_mask(IN_DIR, OUT_DIR):
    ...
    for ind, file in enumerate(files):
        try:
            ...
            # ------ MTL -----------------------------------------------
            aws_path = AWS_18 + image_name[10:13] + '/' + image_name[
                                                      13:16] + '/' + image_name + '/' + image_name + MTL_EXTENSION
            ...
            # ------ Process -----------------------------------------------
            if os.path.exists(os.path.join(OUT_DIR, image_name + '_Murphy.TIF')) or os.path.exists(
                    os.path.join(OUT_DIR, image_name + '_GOLI.TIF')) or os.path.exists(
                    os.path.join(OUT_DIR, image_name + '_Schroeder.TIF')):
                print('    ja processado')
            else:
